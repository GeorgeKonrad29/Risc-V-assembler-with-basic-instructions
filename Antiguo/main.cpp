...
para ello use las siguientes fuentes:
Implementacion de vector realizada en clase
Implementacion de arbol binario de busqueda realizada en clase
Implementacion de Stack realizada como tarea
Uso de ficheros en c++ del siguiente enlace:
https://www2.eii.uva.es/fund_inf/cpp/temas/10_ficheros/ficheros_cpp.html

Este programa tiene el proposito de servir como ensamblador para un procesador RISC-V, el cual convierte las instrucciones
a su equivalente en binario, tomando las instrucciones de un archivo de texto llamado Input.dat y escribiendo el resultado
en un archivo llamado Output.dat, el programa es capaz de identificar las instrucciones de tipo R, I, J, S, U y B

(Informacion más detallada de diferentes funciones sera añadida a lo largo del codigo)   */
